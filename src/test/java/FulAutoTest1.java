...
public class FulAutoTest1 {
  ...
  @Test
  public void testFulAutoTest1() throws Exception {
    ...
    driver.findElement(By.id("searchSystemUser_userName")).sendKeys("that is all for this test");
